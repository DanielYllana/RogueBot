package org.firstinspires.ftc.CV_Algorithm;
...
public class skystoneDetectorClass  {
    ...
    private static float offsetY = 0.1f/8f;//changing this moves the three rects and circles up or down, range: (-4, 4) not inclusive

...
public class opencvSkystoneDetector extends MovementMethod {
    ...
    private static float offsetX = -0.8f/8f;//changing this moves the three rects and the three circles left or right, range : (-2, 2) not inclusive
    private static float offsetY = 0.6f/8f;//changing this moves the three rects and circles up or down, range: (-4, 4) not inclusive
